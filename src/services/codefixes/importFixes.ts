...
namespace ts.codefix {
    ...
    export function getImportCompletionAction(
        ...
        const ctx: ImportCodeFixContext = { host, program, checker, newLineCharacter: host.getNewLine(), compilerOptions, sourceFile, formatContext, symbolName, getCanonicalFileName, symbolToken: undefined };
    ...
    function getCodeActionForUseExistingNamespaceImport(namespacePrefix: string, context: SymbolContext, symbolToken: Node): CodeFixAction {
        const { symbolName, sourceFile } = context;
